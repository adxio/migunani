...
class ApplicationBase extends CI_Controller {
    ...
    protected function base_load_app() {
        ...
        //load style
        $this->smarty->load_style("jquery.ui/smoothness/jquery-ui-1.10.4.custom.css");
        //load javascript
        $this->smarty->load_javascript('resource/js/jquery/jquery-1.10.2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-1.10.4.custom.min.js');
        //js plugins
        $this->smarty->load_javascript("resource/js/jquery.tiny_mce/tiny_mce.js");
